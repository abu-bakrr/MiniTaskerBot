...
Скрипт спросит **минимум вопросов**:
1. Откуда взять код? (GitHub или локальная директория)
2. URL GitHub репозитория (если выбрали GitHub)
3. Ваш домен (необязательно, для SSL)

**Всё остальное настроится автоматически!** Пароли, база данных, сервисы - всё генерируется и настраивается автоматически.
